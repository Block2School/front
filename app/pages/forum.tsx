...
useEffect(() => {
  ...
  const filterBySubreddit = (filter: any) => {
    ...
    const Filt = allPosts.filter((post) => post.category == filter)
    ...
    {isConnected? 
     ...
     <ul>
      <div onClick={()=>setCreateModel(!createModel)}>
       <li className={styles.category_choices}>Create Post</li>
       </div>
     </ul>
      </div> :
      null}
      ...
      <div className={styles.navbar_modal}>
          <div className={styles.navbar_modal_content}>
            ...
            <div className={styles.navbar_modal_links}>
              <h1 className={styles.navbar_modal_title}>Create your post</h1>
