    ...
    <>
      ...
      <div id="terms-of-use-container">
        ...
        <div className="terms-of-use-box">
          <p>
            The Block2School website located at www.block2school.fr is a
            copyrighted work belonging to Block2School. Certain features of the
        ...
        <div className="terms-of-use-box">
          <p>
            ...
            any Third-Party Links and Ads. Company provides access to these
            Third-Party Links and Ads only as a convenience to you, and does not
            review, approve, monitor, endorse, warrant, or make any
            representations with respect to Third-Party Links and Ads. You use
            all Third-Party Links and Ads at your own risk, and should apply a
        ...
        <div className="terms-of-use-box">
          ...
          <p className="terms-of-use-general">
            ...
            Notice to the Company should be sent to: 3 place Paul Bec,
            Montpellier. After the Notice is received, you and the Company may
