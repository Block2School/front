      ...
      <div id="footer-component">
        <div id="footer-container">
          <div id="footer-logo-container">
            <Image src="/B2S_white.png" height="100%" width="100%" alt='B2S Logo' />
          ...
          <div id="footer-community-container">
            <div id="footer-community-main">
              <a href="https://discord.gg/U68HFZMUqc" target="_blank" rel="noreferrer">
                <svg
              ...
              <a href="https://instagram.com/block2school" target="_blank" rel="noreferrer">
                <svg
