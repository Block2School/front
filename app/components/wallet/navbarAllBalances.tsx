        ...
        {active ? (
          <>
            <div id="balances">
              ...
              <NavbarBalance balanceToken={balanceBNB} ImgSrc="/Binance-BNB-Icon2-Logo.wine.svg" alt="BNB logo"/>
            </div>
          </>
        ) : (
          <>
            <div id="balances">
              <NavbarBalance balanceToken={null} ImgSrc="/ethereum-eth-logo.svg" alt="ETH logo"/>
              <NavbarBalance balanceToken={null} ImgSrc="/Binance-BNB-Icon2-Logo.wine.svg" alt="BNB logo"/>
            </div>
          </>
        )}
      </HStack>
